...
export async function getIssue(
  ...
  return githubRequest(
    `${GITHUB_REPOSITORY_URL}${GITHUB_API_VERSION}/repos/${owner}/${repo}/issues/${issue_number}`
  );
}
...
export async function addIssueComment(
  ...
  return githubRequest(
    `${GITHUB_REPOSITORY_URL}${GITHUB_API_VERSION}/repos/${owner}/${repo}/issues/${issue_number}/comments`,
    {
      method: "POST",
      body: { body },
    }
...
export async function createIssue(
  ...
  return githubRequest(
    `${GITHUB_REPOSITORY_URL}${GITHUB_API_VERSION}/repos/${owner}/${repo}/issues`,
    {
      method: "POST",
      body: options,
    }
